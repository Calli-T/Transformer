...
"""Dataset modules based on kaldi-style scp files_for_gen."""
...
class AudioMelSCPDataset(Dataset):
    """PyTorch compatible audio and mel dataset based on kaldi-stype scp files_for_gen."""
    ...
    def __init__(
        ...
        assert len(audio_keys) == len(mel_keys), (
            f"Number of audio and mel files_for_gen are different ({len(audio_keys)} vs"
            f" {len(mel_keys)})."
        )
...
class AudioSCPDataset(Dataset):
    """PyTorch compatible audio dataset based on kaldi-stype scp files_for_gen."""
...
class MelSCPDataset(Dataset):
    """PyTorch compatible mel dataset based on kaldi-stype scp files_for_gen."""
