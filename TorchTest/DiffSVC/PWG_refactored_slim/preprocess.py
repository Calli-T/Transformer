...
from utils.audio_mel_dataset import AudioDataset
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "directory including wav files_for_gen. you need to specify either scp or rootdir."
        ),
    )
    parser.add_argument(
        "--dumpdir",
        type=str,
        required=True,
        help="directory to dump feature files_for_gen.",
    )
    parser.add_argument(
        "--config",
        type=str,
