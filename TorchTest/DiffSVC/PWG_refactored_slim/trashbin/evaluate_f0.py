...
def find_files(
    ...
    """Find files_for_gen recursively.
...
def main():
    ...
    # Get and divide list
    if len(gen_files) == 0:
        raise FileNotFoundError("Not found any generated audio files_for_gen.")
    if len(gen_files) > len(gt_files):
        raise ValueError(
            "#groundtruth files_for_gen are less than #generated files_for_gen "
